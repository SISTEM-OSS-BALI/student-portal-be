...
type AnswerQuestion struct {
	ID           string    `json:"id" gorm:"primaryKey;size:25"`
	SubmissionID *string   `json:"submission_id" gorm:"size:25;index"`
...
type GeneratedStatementLetterAIDocument struct {
	...
	Approvals []StatementLetterAIApproval `json:"approvals,omitempty" gorm:"foreignKey:DocumentID;references:ID"`
	CreatedAt time.Time                   `json:"created_at"`
	UpdatedAt time.Time                   `json:"updated_at"`
}
...
type GeneratedSponsorLetterAIDocument struct {
	...
	Approvals []SponsorLetterAIApproval `json:"approvals,omitempty" gorm:"foreignKey:DocumentID;references:ID"`
	CreatedAt time.Time                 `json:"created_at"`
	UpdatedAt time.Time                 `json:"updated_at"`
}
