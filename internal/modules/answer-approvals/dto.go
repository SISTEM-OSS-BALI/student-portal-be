...
func NewResponseDTO(approval schema.AnswerApproval) ResponseDTO {
	return ResponseDTO{
		ID:         approval.ID,
		AnswerID:   approval.AnswerID,
...
func NewResponseListDTO(items []schema.AnswerApproval) []ResponseDTO {
